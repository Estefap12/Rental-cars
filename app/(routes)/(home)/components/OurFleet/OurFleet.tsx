...
import {Images, MoveRight} from "lucide-react";
import {
    categoryOurFleet,
...
export function OurFleet() {
  return (
    <div className="max-w-6xl mx-auto text-center py-12 lg:py-40 p-6">
        ...
        <p className="text-lg mt-2 lg:mt-5 lg:text-xl text-center w-full mx-auto max-w-3xl mb-5 lg:mb-10">
            Don't deny yourself pleasure of driving the best premium cars from around
